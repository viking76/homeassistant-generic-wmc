"""The generic_dew_point_hygrostat component."""
...
DOMAIN = "generic_dew_point_hygrostat"
...
async def async_setup(hass: HomeAssistant, config: ConfigType) -> bool:
    """Set up the Generic Dew Point Hygrostat component."""
    ...
    for hygrostat_conf in config[DOMAIN]:
        hass.async_create_task(
            discovery.async_load_platform(
                hass, Platform.CLIMATE, DOMAIN, hygrostat_conf, config
            )
        )
